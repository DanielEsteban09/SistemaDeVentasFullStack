namespace SistemaVentas.Utility
{
    ...
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            #region Usuario
            /*
             * El .ForMember es utilizado para convertir una propieda de un tipo de dato a otro
             * por ejemplo podemos convertir la propiedad "Activo" de boolenao a entero.
             */
            ...
            CreateMap<DetalleVenta, ReporteDTO>()
                ...
                .ForMember(destino =>
                    destino.Precio, //Esta propíedad hace referencia al precio de cada producto
                    opt => opt.MapFrom(origen => Convert.ToString(origen.Precio.Value, new CultureInfo("es-CO")))
                )
                .ForMember(destino =>
                    destino.Total,
